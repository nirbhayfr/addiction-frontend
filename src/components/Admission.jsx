...
`.trim();
	...
	const steps = [
		{
			title: "पहला संपर्क",
			titleHn: "गोपनीय सलाह और सहायता",
			desc: "कॉल या हेल्पलाइन के माध्यम से हमारी टीम से बात करें। आपकी जानकारी पूरी तरह सुरक्षित और गोपनीय रखी जाती है।",
			descHn: "समस्या को समझकर सही मार्गदर्शन दिया जाता है।",
		},
		{
			title: "मूल्यांकन और योजना",
			titleHn: "आपकी ज़रूरत के अनुसार सहायता",
			desc: "विशेषज्ञ आपकी स्थिति को समझकर उपचार और देखभाल की उपयुक्त योजना तैयार करते हैं।",
			descHn: "बेहतर परिणाम के लिए सही दिशा तय की जाती है।",
		},
		{
			title: "उपचार और सहयोग",
			titleHn: "नई शुरुआत की ओर कदम",
			desc: "उपचार, परामर्श और परिवार के सहयोग के साथ व्यक्ति को नशा मुक्त जीवन की ओर बढ़ने में मदद की जाती है।",
			descHn: "स्वस्थ और सकारात्मक जीवन की ओर निरंतर सहायता।",
		},
	];
	return (
		<section
					...
					>
						<div>
							...
							<p className="text-sm text-[#5a7a63] mt-3 max-w-lg leading-relaxed">
								नशे से बाहर निकलने की शुरुआत सही सहायता
								से होती है। हम व्यक्ति और परिवार को पूरी
								प्रक्रिया के दौरान सहयोग और मार्गदर्शन
								प्रदान करते हैं।
								<span className="block mt-1 font-sans font-semibold text-[#4a7c59]">
									पूरी गोपनीयता, भरोसेमंद सहायता और
									बेहतर जीवन की ओर एक नया कदम।
								</span>
							</p>
						</div>
