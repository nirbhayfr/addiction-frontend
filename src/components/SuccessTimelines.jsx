						...
						>
							<div className="flex justify-between items-start">
								<div>
									...
									<p className="text-xs text-[#5a7a63] font-medium mt-0.5">
										{story.age} वर्ष •{" "}
										{story.recoverySpan}
									</p>
								</div>
				...
				<div className="lg:col-span-8 bg-white border border-[#c8d8cc] rounded-[40px] p-6 md:p-8 space-y-6">
					<div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 border-b border-[#c8d8cc] pb-4">
						...
						<button
							...
							className={`px-5 py-2 rounded-full font-sans font-bold text-xs flex items-center gap-2 self-start transition-all ${
								liked[selected.id]
					...
					<h4 className="font-sans font-extrabold text-xs text-[#1a4731] uppercase">
					...
					<div className="relative border-l-2 border-[#c8d8cc] ml-4 pl-6 space-y-8 py-2">
						{selected.milestones.map((ms, idx) => (
							<div key={idx} className="relative">
								...
								<p className="text-xs text-[#5a7a63] font-medium mt-1 leading-relaxed">
									{ms.desc}
								</p>
							</div>
						))}
			...
			<div className="bg-[#f0f5f1] border border-[#c8d8cc] rounded-[40px] p-6 md:p-10 text-left">
				<div className="grid grid-cols-1 lg:grid-cols-12 gap-8">
					<div className="lg:col-span-5 space-y-4">
						...
						<p className="text-xs text-[#5a7a63] leading-relaxed">
						...
						>
							<textarea
								...
								maxLength={200}
								required
								className="w-full bg-white border border-[#c8d8cc] rounded-xl p-4 text-xs font-medium text-[#1a4731] focus:ring-2 focus:ring-[#1a4731] resize-none h-24 outline-none transition-all"
							/>
							...
							<div className="flex gap-2">
								<input
									...
									className="flex-1 bg-white border border-[#c8d8cc] rounded-xl px-3 py-2 text-xs font-medium text-[#1a4731] focus:ring-2 focus:ring-[#1a4731] outline-none transition-all"
								/>

								<button
									type="submit"
									className="bg-[#1a4731] hover:bg-[#2d6b4f] text-white px-5 rounded-xl text-xs font-sans font-bold flex items-center gap-1 active:scale-95 transition-all"
								>
						...
						{success && (
							<div className="p-3 bg-emerald-50 text-emerald-800 border-l-4 border-emerald-500 rounded-r-xl text-xs font-bold flex items-center gap-2">
					...
					<div className="lg:col-span-7 space-y-4">
						<h4 className="font-sans font-extrabold text-xs text-[#1a4731] uppercase tracking-widest px-1">
						...
						<div className="space-y-3 max-h-[340px] overflow-y-auto pr-2">
							{letters.map((l) => (
								...
								>
									...
									<p className="text-xs text-[#1c2e24] leading-relaxed italic">
										"{l.text}"
									</p>
